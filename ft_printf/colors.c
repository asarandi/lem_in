...
/*   Updated: 2017/11/11 22:53:36 by asarandi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_more_colors(char *str)
{
	if (ft_strmatch("{black2}", str))
		return (write(1, "\033[1;30m", 7));
	if (ft_strmatch("{red2}", str))
		return (write(1, "\033[1;31m", 7));
	if (ft_strmatch("{green2}", str))
		return (write(1, "\033[1;32m", 7));
	if (ft_strmatch("{yellow2}", str))
		return (write(1, "\033[1;33m", 7));
	if (ft_strmatch("{blue2}", str))
		return (write(1, "\033[1;34m", 7));
	if (ft_strmatch("{magenta2}", str))
		return (write(1, "\033[1;35m", 7));
	if (ft_strmatch("{cyan2}", str))
		return (write(1, "\033[1;36m", 7));
	if (ft_strmatch("{white2}", str))
		return (write(1, "\033[1;37m", 7));
	return (0);
}
...
int	check_colors(char *str)
{
	if (ft_strmatch("{eoc}", str))
		return (write(1, "\033[0;00m", 7));
	if (ft_strmatch("{black}", str))
		return (write(1, "\033[0;30m", 7));
	...
	if (ft_strmatch("{white}", str))
		return (write(1, "\033[0;37m", 7));
	return (check_more_colors(str));
}
